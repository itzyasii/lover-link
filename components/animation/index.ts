// Animation assets exports - provides correct import paths for all animations
export const HEARTBEAT_LOTTIE = "./heartbeat.lottie";
...
// Export components
export { HeartbeatAnimation } from "./HeartbeatAnimation";
